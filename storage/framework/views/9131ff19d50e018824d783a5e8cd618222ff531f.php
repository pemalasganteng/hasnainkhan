...
<div class="main">
        <section class="module bg-dark-60 blog-page-header" data-background="<?php echo e(asset('/master/assets/images/3.jpg')); ?>">
          <div class="container">
            <div class="row">
              ...
              <div class="col-sm-8">
                ...
                <?php $__currentLoopData = $berita; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>	
                  <div class="col-md-6 col-lg-6">
                    <div class="post">
                      <div class="post-thumbnail"><a href="#"><img src="/wysiwyg/<?php echo e($b->cover); ?>" alt="<?php echo e($b->judul); ?>"/></a></div>
                      <div class="post-header font-alt">
                        <h2 class="post-title"><a href="#"><?php echo e($b->judul); ?></a></h2>
                        <div class="post-meta">By&nbsp;<a href="#">Mark Stone</a>&nbsp;| <?php echo e($b->tanggal); ?> | 3 Comments
                        </div>
                      </div>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\abrisam\AppData\Local\gitkraken\app-6.1.4\hasnainkhan\resources\views/master/berita.blade.php ENDPATH**/ ?>