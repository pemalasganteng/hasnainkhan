	<?php $__env->startSection('isi'); ?>
		...
		<section class="home-section home-parallax home-fade home-full-height bg-dark-60 agency-page-header" id="home" data-background="<?php echo e(asset('master/assets/images/3.jpg')); ?>">
          ...
          <div class="container">
            ...
            <ul class="works-grid works-grid-gut works-grid-3 works-hover-d" id="works-grid">
              <li class="work-item illustration webdesign"><a href="portfolio_single_featured_image1.html">
                  <div class="work-image"><img src="<?php echo e(asset('master/assets/images/portfolio/grid-portfolio1.jpg')); ?>" alt="Portfolio Item"/></div>
                  <div class="work-caption font-alt">
                    <h3 class="work-title">Corporate Identity</h3>
                    <div class="work-descr">Illustration</div>
                  </div></a></li>
              <li class="work-item marketing photography"><a href="portfolio_single_featured_image2.html">
                  <div class="work-image"><img src="<?php echo e(asset('master/assets/images/portfolio/grid-portfolio2.jpg')); ?>" alt="Portfolio Item"/></div>
                  <div class="work-caption font-alt">
                    <h3 class="work-title">Bag MockUp</h3>
                    <div class="work-descr">Marketing</div>
                  </div></a></li>
              <li class="work-item illustration photography"><a href="portfolio_single_featured_slider1.html">
                  <div class="work-image"><img src="<?php echo e(asset('master/assets/images/portfolio/grid-portfolio3.jpg')); ?>" alt="Portfolio Item"/></div>
                  <div class="work-caption font-alt">
                    <h3 class="work-title">Disk Cover</h3>
                    <div class="work-descr">Illustration</div>
                  </div></a></li>
              <li class="work-item marketing photography"><a href="portfolio_single_featured_slider2.htmll">
                  <div class="work-image"><img src="<?php echo e(asset('master/assets/images/portfolio/grid-portfolio4.jpg')); ?>" alt="Portfolio Item"/></div>
                  <div class="work-caption font-alt">
              ...
              <li class="work-item illustration webdesign"><a href="portfolio_single_featured_video1.html">
                  <div class="work-image"><img src="<?php echo e(asset('master/assets/images/portfolio/grid-portfolio5.jpg')); ?>" alt="Portfolio Item"/></div>
                  <div class="work-caption font-alt">
              ...
              <li class="work-item marketing webdesign"><a href="portfolio_single_featured_video2.html">
                  <div class="work-image"><img src="<?php echo e(asset('master/assets/images/portfolio/grid-portfolio6.jpg')); ?>" alt="Portfolio Item"/></div>
                  <div class="work-caption font-alt">
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\abrisam\AppData\Local\gitkraken\app-6.1.4\hasnainkhan\resources\views/master/perbankan.blade.php ENDPATH**/ ?>