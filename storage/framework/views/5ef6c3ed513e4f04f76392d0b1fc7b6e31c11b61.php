        ...
        <div class="hero-slider">
          <ul class="slides">
           <?php $__currentLoopData = $slider; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li class="bg-dark-30 bg-dark" style="background-image:url(<?php echo e(url('gambar/slider/'.$slider->gambar)); ?>);">
              <div class="titan-caption">
                <div class="caption-content">
                  <div class="font-alt mb-30 titan-title-size-1"><?php echo e($slider->judul); ?></div>
                  <div class="font-alt mb-40 titan-title-size-4"><?php echo e($slider->deskripsi); ?></div><a class="section-scroll btn btn-border-w btn-round" href="#about">INFO</a>
                </div>
              </div>
            </li>
        ...
        <section class="module" id="about">
          <div class="container">
            <div class="row">
              ...
              <?php $__currentLoopData = $katadepan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $katadepan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <h2 class="module-title font-alt"><?php echo e($katadepan->judul); ?></h2>
                <div class="module-subtitle font-serif large-text"><?php echo e($katadepan->isi); ?>.</div>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </div>
            </div>
            <div class="row">
          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-6 col-sm-offset-3">
                ...
                <h2 class="module-title font-alt"><?php echo e($master->judul); ?></h2>
                <div class="module-subtitle font-serif"><?php echo e($master->deskripsi); ?></div>
              </div>
            </div>
            <div class="row multi-columns-row">
              ...
              <?php $__currentLoopData = $keunggulan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $keunggulans): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <?php if($keunggulans->id == 1) continue; ?>
                  
              <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="features-item">
                  <div class="features-icon"><span class="<?php echo e($keunggulans->icon); ?>"></span></div>
                  <h3 class="features-title font-alt"><?php echo e($keunggulans->subjudul); ?></h3>
                  <p><?php echo e($keunggulans->isi); ?></p>
          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-6 col-sm-offset-3">
                ...
                <h2 class="module-title font-alt"><?php echo e($kepala->judul); ?></h2>
                <div class="module-subtitle font-serif"><?php echo e($kepala->isi); ?></div>
            ...
            <div class="row">
              ...
              <div class="col-md-6 col-lg-6 hidden-xs hidden-sm">
                <div class="alt-services-image align-center"><img src="<?php echo e(url('gambar/kepala_sekolah/'.$kepala->gambar)); ?>" alt="Feature Image"></div>
              </div>
              <div class="col-sm-6 col-md-3 col-lg-3">
              </div>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\abrisam\AppData\Local\gitkraken\app-6.1.4\hasnainkhan\resources\views/master/index.blade.php ENDPATH**/ ?>